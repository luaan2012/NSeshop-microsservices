...
namespace NSE.WebApp.MVC.Services
{
    public interface IComprasBffService
    {
        ...
        // Pedido
        Task<ResponseResult> FinalizarPedido(OrderTransacaoViewModel pedidoTransacao);
        Task<OrderViewModel> ObterUltimoPedido();
        Task<IEnumerable<OrderViewModel>> ObterListaPorClienteId();
        OrderTransacaoViewModel MapearParaPedido(CarrinhoViewModel carrinho, EnderecoViewModel endereco);
    }
    ...
    public class ComprasBffService : Service, IComprasBffService
    {
        ...
        public async Task<ResponseResult> FinalizarPedido(OrderTransacaoViewModel pedidoTransacao)
        {
        ...
        public OrderTransacaoViewModel MapearParaPedido(CarrinhoViewModel carrinho, EnderecoViewModel endereco)
        {
